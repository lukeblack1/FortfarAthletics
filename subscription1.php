...
if ( $_SERVER[ 'REQUEST_METHOD' ] == 'POST' )
{
  ...
  if ( empty( $errors ) ) 
  {
	...
	</h1><strong>Thank you for subscribing</strong></h1> <p><b><font color="#663300"><a href="index2.php?user_id=' . $row["user_id"] . '">Click here</a></font></b> To go back to home page</p>'; }
  echo '<td></td>';
